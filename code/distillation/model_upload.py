...
# === Modal setup ===
volume = Volume.from_name("noisy-covid-regression-half", create_if_missing=False)
...
REPO_ID = "cpondoc/covid-one-half-regression-classifier"
FOLDER_PATH = "/vol/checkpoints/half-trec-covid-noise/final"
