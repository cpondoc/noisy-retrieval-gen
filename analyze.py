...
def save_mismatch_results(mismatch_results):
    ...
    save_folder = "data/120-examples-general"
...
if __name__ == "__main__":
    ...
    noisy_ir = analyze_mteb_predictions("noisy_results/120-examples/Snowflake/snowflake-arctic-embed-m/NFCorpus/NFCorpus_default_predictions.json")
