...
if __name__ == "__main__":
    ...
    noisy_ir = analyze_mteb_predictions("noisy_results/200-specific-examples/Snowflake/snowflake-arctic-embed-m/NFCorpus/NFCorpus_default_predictions.json")
